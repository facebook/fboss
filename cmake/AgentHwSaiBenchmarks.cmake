...
function(BUILD_SAI_BENCHMARKS SAI_IMPL_NAME SAI_IMPL_ARG)
  ...
  add_executable(sai_rib_conversion_speed-${SAI_IMPL_NAME}-${SAI_VER_SUFFIX} /dev/null)

  target_link_libraries(sai_rib_conversion_speed-${SAI_IMPL_NAME}-${SAI_VER_SUFFIX}
    -Wl,--whole-archive
    sai_switch_ensemble
  ...
  set_target_properties(sai_rib_conversion_speed-${SAI_IMPL_NAME}-${SAI_VER_SUFFIX}
    PROPERTIES COMPILE_FLAGS
    "-DSAI_VER_MAJOR=${SAI_VER_MAJOR} \
    -DSAI_VER_MINOR=${SAI_VER_MINOR}  \
    -DSAI_VER_RELEASE=${SAI_VER_RELEASE}"
