...
# ./run_test.py sai --config $confFile --coldboot_only --filter_file=$filter-file # fboss.git/oss/sai_known_good_tests/ for filter files
#
# Running non-OSS:
...
if __name__ == "__main__":
    ...
    ap.add_argument(
        ...
        help=(
            ...
            + OPT_ARG_FILTER_FILE
            + "=/fboss.git/oss/sai_known_good_tests//known-good_regexes-brcm-sai-9.0_ea_dnx_odp-jericho2"
        ),
    )
    ap.add_argument(
        OPT_ARG_LIST_TESTS,
