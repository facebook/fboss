...
CmdSetInterfacePrbsState::RetType CmdSetInterfacePrbsState::queryClient(
...
CmdSetInterfacePrbsState::RetType CmdSetInterfacePrbsState::createModel(
    const HostInfo& hostInfo,
    const utils::PortList& queriedIfs,
    const utils::PrbsComponent& components,
    const ObjectArgType& state) {
...
void CmdSetInterfacePrbsState::setPrbsState(
    const HostInfo& hostInfo,
...
void CmdSetInterfacePrbsState::printOutput(
    const RetType& model,
    std::ostream& out) {
  out << model << std::endl;
}
