...
class CmdConfigProtocolBgpPeerGroupDescription
    : public CmdHandler<
          CmdConfigProtocolBgpPeerGroupDescription,
          CmdConfigProtocolBgpPeerGroupDescriptionTraits> {
 public:
  using ObjectArgType =
      CmdConfigProtocolBgpPeerGroupDescriptionTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpPeerGroupDescriptionTraits::RetType;
