...
class CmdConfigProtocolBgpPeerGroupMaxRoutes
    : public CmdHandler<
          CmdConfigProtocolBgpPeerGroupMaxRoutes,
          CmdConfigProtocolBgpPeerGroupMaxRoutesTraits> {
 public:
  using ObjectArgType =
      CmdConfigProtocolBgpPeerGroupMaxRoutesTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpPeerGroupMaxRoutesTraits::RetType;
