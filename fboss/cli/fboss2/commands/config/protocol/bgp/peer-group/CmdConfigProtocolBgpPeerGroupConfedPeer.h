...
class CmdConfigProtocolBgpPeerGroupConfedPeer
    : public CmdHandler<
          CmdConfigProtocolBgpPeerGroupConfedPeer,
          CmdConfigProtocolBgpPeerGroupConfedPeerTraits> {
 public:
  using ObjectArgType =
      CmdConfigProtocolBgpPeerGroupConfedPeerTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpPeerGroupConfedPeerTraits::RetType;
