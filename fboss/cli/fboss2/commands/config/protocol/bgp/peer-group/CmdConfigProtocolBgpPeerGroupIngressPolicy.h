...
class CmdConfigProtocolBgpPeerGroupIngressPolicy
    : public CmdHandler<
          CmdConfigProtocolBgpPeerGroupIngressPolicy,
          CmdConfigProtocolBgpPeerGroupIngressPolicyTraits> {
 public:
  using ObjectArgType =
      CmdConfigProtocolBgpPeerGroupIngressPolicyTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpPeerGroupIngressPolicyTraits::RetType;
