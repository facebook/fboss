...
class CmdConfigProtocolBgpPeerGroupWarningOnly
    : public CmdHandler<
          CmdConfigProtocolBgpPeerGroupWarningOnly,
          CmdConfigProtocolBgpPeerGroupWarningOnlyTraits> {
 public:
  using ObjectArgType =
      CmdConfigProtocolBgpPeerGroupWarningOnlyTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpPeerGroupWarningOnlyTraits::RetType;

  RetType queryClient(
      const HostInfo& hostInfo,
      const utils::Message& groupName,
      const ObjectArgType& warningOnly);
