...
class CmdConfigProtocolBgpPeerGroupDisableIpv4Afi
    : public CmdHandler<
          CmdConfigProtocolBgpPeerGroupDisableIpv4Afi,
          CmdConfigProtocolBgpPeerGroupDisableIpv4AfiTraits> {
 public:
  using ObjectArgType =
      CmdConfigProtocolBgpPeerGroupDisableIpv4AfiTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpPeerGroupDisableIpv4AfiTraits::RetType;
