...
class CmdConfigProtocolBgpPeerGroupEgressPolicy
    : public CmdHandler<
          CmdConfigProtocolBgpPeerGroupEgressPolicy,
          CmdConfigProtocolBgpPeerGroupEgressPolicyTraits> {
 public:
  using ObjectArgType =
      CmdConfigProtocolBgpPeerGroupEgressPolicyTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpPeerGroupEgressPolicyTraits::RetType;
