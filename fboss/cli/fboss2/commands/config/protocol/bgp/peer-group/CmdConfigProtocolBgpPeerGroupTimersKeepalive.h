...
class CmdConfigProtocolBgpPeerGroupTimersKeepalive
    : public CmdHandler<
          CmdConfigProtocolBgpPeerGroupTimersKeepalive,
          CmdConfigProtocolBgpPeerGroupTimersKeepaliveTraits> {
 public:
  using ObjectArgType =
      CmdConfigProtocolBgpPeerGroupTimersKeepaliveTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpPeerGroupTimersKeepaliveTraits::RetType;

  RetType queryClient(
      const HostInfo& hostInfo,
      const utils::Message& peerGroupName,
      const ObjectArgType& keepalive);
