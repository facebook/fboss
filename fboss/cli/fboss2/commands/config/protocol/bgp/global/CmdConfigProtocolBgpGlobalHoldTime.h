...
class CmdConfigProtocolBgpGlobalHoldTime
    : public CmdHandler<
          CmdConfigProtocolBgpGlobalHoldTime,
          CmdConfigProtocolBgpGlobalHoldTimeTraits> {
 public:
  using ObjectArgType = CmdConfigProtocolBgpGlobalHoldTimeTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpGlobalHoldTimeTraits::RetType;

  RetType queryClient(const HostInfo& hostInfo, const ObjectArgType& holdTime);
