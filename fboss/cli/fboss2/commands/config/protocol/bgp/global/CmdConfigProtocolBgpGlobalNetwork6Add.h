...
class CmdConfigProtocolBgpGlobalNetwork6Add
    : public CmdHandler<
          CmdConfigProtocolBgpGlobalNetwork6Add,
          CmdConfigProtocolBgpGlobalNetwork6AddTraits> {
 public:
  using ObjectArgType =
      CmdConfigProtocolBgpGlobalNetwork6AddTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpGlobalNetwork6AddTraits::RetType;
