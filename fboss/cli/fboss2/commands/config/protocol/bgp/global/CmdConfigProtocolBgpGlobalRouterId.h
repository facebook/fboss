...
class CmdConfigProtocolBgpGlobalRouterId
    : public CmdHandler<
          CmdConfigProtocolBgpGlobalRouterId,
          CmdConfigProtocolBgpGlobalRouterIdTraits> {
 public:
  using ObjectArgType = CmdConfigProtocolBgpGlobalRouterIdTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpGlobalRouterIdTraits::RetType;

  RetType queryClient(const HostInfo& hostInfo, const ObjectArgType& routerId);
