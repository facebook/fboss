...
class CmdConfigProtocolBgpGlobalConfedAsn
    : public CmdHandler<
          CmdConfigProtocolBgpGlobalConfedAsn,
          CmdConfigProtocolBgpGlobalConfedAsnTraits> {
 public:
  using ObjectArgType =
      CmdConfigProtocolBgpGlobalConfedAsnTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpGlobalConfedAsnTraits::RetType;

  RetType queryClient(const HostInfo& hostInfo, const ObjectArgType& confedAsn);
