...
class CmdConfigProtocolBgpGlobalLocalAsn
    : public CmdHandler<
          CmdConfigProtocolBgpGlobalLocalAsn,
          CmdConfigProtocolBgpGlobalLocalAsnTraits> {
 public:
  using ObjectArgType = CmdConfigProtocolBgpGlobalLocalAsnTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpGlobalLocalAsnTraits::RetType;

  RetType queryClient(const HostInfo& hostInfo, const ObjectArgType& localAsn);
