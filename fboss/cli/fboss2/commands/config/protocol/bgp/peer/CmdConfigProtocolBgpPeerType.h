...
class CmdConfigProtocolBgpPeerType : public CmdHandler<
                                         CmdConfigProtocolBgpPeerType,
                                         CmdConfigProtocolBgpPeerTypeTraits> {
 public:
  using ObjectArgType = CmdConfigProtocolBgpPeerTypeTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpPeerTypeTraits::RetType;

  RetType queryClient(
      const HostInfo& hostInfo,
      const utils::IPList& peerAddress,
      const ObjectArgType& peerType);
