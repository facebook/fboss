...
class CmdConfigProtocolBgpPeerDescription
    : public CmdHandler<
          CmdConfigProtocolBgpPeerDescription,
          CmdConfigProtocolBgpPeerDescriptionTraits> {
 public:
  using ObjectArgType =
      CmdConfigProtocolBgpPeerDescriptionTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpPeerDescriptionTraits::RetType;
