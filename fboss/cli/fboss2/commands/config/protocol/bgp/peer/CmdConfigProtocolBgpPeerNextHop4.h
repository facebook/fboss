...
class CmdConfigProtocolBgpPeerNextHop4
    : public CmdHandler<
          CmdConfigProtocolBgpPeerNextHop4,
          CmdConfigProtocolBgpPeerNextHop4Traits> {
 public:
  using ObjectArgType = CmdConfigProtocolBgpPeerNextHop4Traits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpPeerNextHop4Traits::RetType;

  RetType queryClient(
      const HostInfo& hostInfo,
      const utils::IPList& peerAddress,
      const ObjectArgType& nextHop4);
