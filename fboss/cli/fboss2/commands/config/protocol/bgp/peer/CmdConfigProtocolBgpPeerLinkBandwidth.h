...
class CmdConfigProtocolBgpPeerLinkBandwidth
    : public CmdHandler<
          CmdConfigProtocolBgpPeerLinkBandwidth,
          CmdConfigProtocolBgpPeerLinkBandwidthTraits> {
 public:
  using ObjectArgType =
      CmdConfigProtocolBgpPeerLinkBandwidthTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpPeerLinkBandwidthTraits::RetType;

  RetType queryClient(
      const HostInfo& hostInfo,
      const utils::IPList& peerAddress,
      const ObjectArgType& bandwidth);
