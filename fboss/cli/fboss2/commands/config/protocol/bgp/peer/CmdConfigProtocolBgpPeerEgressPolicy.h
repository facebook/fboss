...
class CmdConfigProtocolBgpPeerEgressPolicy
    : public CmdHandler<
          CmdConfigProtocolBgpPeerEgressPolicy,
          CmdConfigProtocolBgpPeerEgressPolicyTraits> {
 public:
  using ObjectArgType =
      CmdConfigProtocolBgpPeerEgressPolicyTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpPeerEgressPolicyTraits::RetType;
