...
class CmdConfigProtocolBgpPeerTimersKeepalive
    : public CmdHandler<
          CmdConfigProtocolBgpPeerTimersKeepalive,
          CmdConfigProtocolBgpPeerTimersKeepaliveTraits> {
 public:
  using ObjectArgType =
      CmdConfigProtocolBgpPeerTimersKeepaliveTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpPeerTimersKeepaliveTraits::RetType;
