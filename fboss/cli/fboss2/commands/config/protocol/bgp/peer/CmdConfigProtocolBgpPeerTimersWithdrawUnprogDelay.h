...
class CmdConfigProtocolBgpPeerTimersWithdrawUnprogDelay
    : public CmdHandler<
          CmdConfigProtocolBgpPeerTimersWithdrawUnprogDelay,
          CmdConfigProtocolBgpPeerTimersWithdrawUnprogDelayTraits> {
 public:
  using ObjectArgType =
      CmdConfigProtocolBgpPeerTimersWithdrawUnprogDelayTraits::ObjectArgType;
  using RetType =
  ...
  RetType queryClient(
      ...
      const ObjectArgType& withdrawUnprogDelay);
