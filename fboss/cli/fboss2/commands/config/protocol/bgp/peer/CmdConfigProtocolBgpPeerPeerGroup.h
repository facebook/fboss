...
class CmdConfigProtocolBgpPeerPeerGroup
    : public CmdHandler<
          CmdConfigProtocolBgpPeerPeerGroup,
          CmdConfigProtocolBgpPeerPeerGroupTraits> {
 public:
  using ObjectArgType = CmdConfigProtocolBgpPeerPeerGroupTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpPeerPeerGroupTraits::RetType;

  RetType queryClient(
      const HostInfo& hostInfo,
      const utils::IPList& peerAddress,
      const ObjectArgType& peerGroupName);
