...
CmdConfigProtocolBgpPeerRrClientTraits::RetType
CmdConfigProtocolBgpPeerRrClient::queryClient(
  ...
  session.setPeerRrClient(peerAddress, enable);
  session.saveConfig();

  return fmt::format(
      "Successfully {} route-reflector-client for peer '{}'\n"
      "Config saved to: {}",
...
void CmdConfigProtocolBgpPeerRrClient::printOutput(const RetType& output) {
