...
class CmdConfigProtocolBgpPeerIngressPolicy
    : public CmdHandler<
          CmdConfigProtocolBgpPeerIngressPolicy,
          CmdConfigProtocolBgpPeerIngressPolicyTraits> {
 public:
  using ObjectArgType =
      CmdConfigProtocolBgpPeerIngressPolicyTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpPeerIngressPolicyTraits::RetType;
