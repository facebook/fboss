...
class CmdConfigProtocolBgpPeerLocalAddr
    : public CmdHandler<
          CmdConfigProtocolBgpPeerLocalAddr,
          CmdConfigProtocolBgpPeerLocalAddrTraits> {
 public:
  using ObjectArgType = CmdConfigProtocolBgpPeerLocalAddrTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpPeerLocalAddrTraits::RetType;

  RetType queryClient(
      const HostInfo& hostInfo,
      const utils::IPList& peerAddress,
      const ObjectArgType& localAddr);
