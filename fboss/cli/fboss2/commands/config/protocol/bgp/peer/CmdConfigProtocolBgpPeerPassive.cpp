...
CmdConfigProtocolBgpPeerPassiveTraits::RetType
CmdConfigProtocolBgpPeerPassive::queryClient(
  ...
  session.setPeerPassive(peerAddress, enable);
  session.saveConfig();

  return fmt::format(
      "Successfully {} passive mode for peer '{}'\n"
      "Config saved to: {}",
...
void CmdConfigProtocolBgpPeerPassive::printOutput(const RetType& output) {
