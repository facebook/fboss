...
class CmdConfigProtocolBgpPeerRemoteAsn
    : public CmdHandler<
          CmdConfigProtocolBgpPeerRemoteAsn,
          CmdConfigProtocolBgpPeerRemoteAsnTraits> {
 public:
  using ObjectArgType = CmdConfigProtocolBgpPeerRemoteAsnTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpPeerRemoteAsnTraits::RetType;
