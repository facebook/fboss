...
class CmdConfigProtocolBgpPeerRrClient
    : public CmdHandler<
          CmdConfigProtocolBgpPeerRrClient,
          CmdConfigProtocolBgpPeerRrClientTraits> {
 public:
  using ObjectArgType = CmdConfigProtocolBgpPeerRrClientTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpPeerRrClientTraits::RetType;
