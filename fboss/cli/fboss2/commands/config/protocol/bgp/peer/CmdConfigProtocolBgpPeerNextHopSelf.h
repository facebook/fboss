...
class CmdConfigProtocolBgpPeerNextHopSelf
    : public CmdHandler<
          CmdConfigProtocolBgpPeerNextHopSelf,
          CmdConfigProtocolBgpPeerNextHopSelfTraits> {
 public:
  using ObjectArgType =
      CmdConfigProtocolBgpPeerNextHopSelfTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpPeerNextHopSelfTraits::RetType;
