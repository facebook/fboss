...
class CmdConfigProtocolBgpPeerMaxRoutes
    : public CmdHandler<
          CmdConfigProtocolBgpPeerMaxRoutes,
          CmdConfigProtocolBgpPeerMaxRoutesTraits> {
 public:
  using ObjectArgType = CmdConfigProtocolBgpPeerMaxRoutesTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpPeerMaxRoutesTraits::RetType;

  RetType queryClient(
      const HostInfo& hostInfo,
      const utils::IPList& peerAddress,
      const ObjectArgType& maxRoutes);
