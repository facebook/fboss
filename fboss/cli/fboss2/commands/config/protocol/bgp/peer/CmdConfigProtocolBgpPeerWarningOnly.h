...
class CmdConfigProtocolBgpPeerWarningOnly
    : public CmdHandler<
          CmdConfigProtocolBgpPeerWarningOnly,
          CmdConfigProtocolBgpPeerWarningOnlyTraits> {
 public:
  using ObjectArgType =
      CmdConfigProtocolBgpPeerWarningOnlyTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpPeerWarningOnlyTraits::RetType;
