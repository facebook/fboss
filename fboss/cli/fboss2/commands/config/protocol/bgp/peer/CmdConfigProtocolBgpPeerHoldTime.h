...
class CmdConfigProtocolBgpPeerHoldTime
    : public CmdHandler<
          CmdConfigProtocolBgpPeerHoldTime,
          CmdConfigProtocolBgpPeerHoldTimeTraits> {
 public:
  using ObjectArgType = CmdConfigProtocolBgpPeerHoldTimeTraits::ObjectArgType;
  using RetType = CmdConfigProtocolBgpPeerHoldTimeTraits::RetType;
