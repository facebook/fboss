...
class CmdConfigDhcpReplySourceOverride
    : public CmdHandler<
          CmdConfigDhcpReplySourceOverride,
          CmdConfigDhcpReplySourceOverrideTraits> {
 public:
  using ObjectArgType = CmdConfigDhcpReplySourceOverrideTraits::ObjectArgType;
  using RetType = CmdConfigDhcpReplySourceOverrideTraits::RetType;
