...
// Register command using distributed registration system
namespace {
facebook::fboss::CommandDef<facebook::fboss::CmdConfigInterface>
    registerConfigInterface(
        "config interface",
        "Configure interface settings");

facebook::fboss::AttributeDef registerConfigInterfaceDescription(
    "config interface description",
    "Set interface description",
    facebook::fboss::utils::ObjectArgTypeId::OBJECT_ARG_TYPE_ID_MESSAGE);

facebook::fboss::AttributeDef registerConfigInterfaceMtu(
    "config interface mtu",
    "Set interface MTU",
    facebook::fboss::utils::ObjectArgTypeId::OBJECT_ARG_TYPE_MTU);
} // namespace
