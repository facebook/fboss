...
TEST_F(CmdShowCpuPortTestFixture, wikiDocHooks) {
  EXPECT_FALSE(CmdShowCpuPortTraits::description().empty());
  EXPECT_FALSE(CmdShowCpuPort::sampleModel().cpuPortStatEntries()->empty());
}
