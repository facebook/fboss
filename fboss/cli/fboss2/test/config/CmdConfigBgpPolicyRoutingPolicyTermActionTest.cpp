...
using facebook::bgp::bgp_policy::CommunityActionType;
using facebook::bgp::bgp_policy::FlowControlAction;
using facebook::bgp::bgp_policy::MedActionType;
using facebook::bgp::bgp_policy::Origin;
using facebook::bgp::bgp_policy::WeightActionType;
