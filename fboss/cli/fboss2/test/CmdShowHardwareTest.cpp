...
folly::dynamic createHardwareEntries() {
  ...
  folly::dynamic pimpresent = folly::dynamic::object
    ("pim2", "Present")
    ("pim1", "Present")
  ;
  entries["PIMPRESENT"] = pimpresent;

  folly::dynamic pimserial = folly::dynamic::object
    ("PIM2", "A123456")
    ("PIM1", "A654321")
  ;
  ...
  folly::dynamic seutil = folly::dynamic::object
    ...
    ("Product Serial Number", "Z123456")
  ;
  entries["SEUTIL"] = seutil;

  folly::dynamic fruid = folly::dynamic::object
    ("Extended MAC Base", "F6:E5:D4:C3:B2:A1")
