...
struct MKAParticipantCtx {
  ...
  2: mka_config.MKAConfidentialityOffset confidentOffset =
      mka_config.MKAConfidentialityOffset.CONFIDENTIALITY_NO_OFFSET,
  ...
  14: string kek,
  15: string l2Port,
  16: mka_config.MKACipherSuite cipher =
        mka_config.MKACipherSuite.GCM_AES_XPN_128,
  17: string srcMac,
  18: bool valid = false;
}
