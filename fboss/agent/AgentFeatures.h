...
DECLARE_bool(enable_pre_manager_delta_logging);
DECLARE_string(pre_manager_delta_log_file);
DECLARE_string(pre_manager_delta_log_protocol);
...
DECLARE_bool(montblanc_precoding);
...
DECLARE_string(bcm_sdk_log_file);
