...
def main():
    ...
    ap.add_argument('-P', '--port',
                    type=int, default=1,
                    help='The port to send the packet to')
    ap.add_argument('-V', '--vlan',
                    type=int, default=1,
                    help='The VLAN to send the packet to')
    ap.add_argument('-f', '--hex-file',
                    help='A file containing hex packet data')
    ap.add_argument('-r', '--raw-file',
                    help='A file containing raw packet data')
    args = ap.parse_args()
