...
TEST(ResourceLibUtilTest, SakKeyHexGenerator) {
  ...
  std::array<std::string, 5> expectedKeys{
      "faceb00cfaceb00cfaceb00cfaceb00cfaceb00cfaceb00c0000000000000001",
      "faceb00cfaceb00cfaceb00cfaceb00cfaceb00cfaceb00c0000000000000002",
      "faceb00cfaceb00cfaceb00cfaceb00cfaceb00cfaceb00c0000000000000003",
      "faceb00cfaceb00cfaceb00cfaceb00cfaceb00cfaceb00c0000000000000004",
      "faceb00cfaceb00cfaceb00cfaceb00cfaceb00cfaceb00c0000000000000005",
  };
  std::array<std::string, 5> expectedKeys2{
      "faceb00cfaceb00cfaceb00cfaceb00cfaceb00cfaceb00c000000000000000a",
      "faceb00cfaceb00cfaceb00cfaceb00cfaceb00cfaceb00c000000000000000b",
      "faceb00cfaceb00cfaceb00cfaceb00cfaceb00cfaceb00c000000000000000c",
      "faceb00cfaceb00cfaceb00cfaceb00cfaceb00cfaceb00c000000000000000d",
      "faceb00cfaceb00cfaceb00cfaceb00cfaceb00cfaceb00c000000000000000e",
  };

  for (auto expectedKey : expectedKeys) {
    auto keyHex = generator.getNext();
    EXPECT_EQ(keyHex.length(), 64);
    EXPECT_EQ(keyHex, expectedKey);
  }
...
TEST(ResourceLibUtilTest, SakKeyIdHexGenerator) {
  ...
  for (auto expectedKey : expectedKeys) {
    auto keyIdHex = generator.getNext();
    EXPECT_EQ(keyIdHex.length(), 32);
    EXPECT_EQ(keyIdHex, expectedKey);
  }
  ...
  for (auto expectedKey : expectedKeys2) {
    auto keyIdHex = generator.getNext();
    EXPECT_EQ(keyIdHex.length(), 32);
    ASSERT_EQ(keyIdHex, expectedKey);
  }
}
