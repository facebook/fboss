...
const std::shared_ptr<ForwardingInformationBaseV6> cfib(
  ...
  return newState->getFibsInfoMap()->getFibContainerIf(RouterID(0))->getFibV6();
}

const std::shared_ptr<ForwardingInformationBaseV4> cfib4(
    const std::shared_ptr<SwitchState>& newState) {
  return newState->getFibsInfoMap()->getFibContainerIf(RouterID(0))->getFibV4();
}
...
void assertRibFibEquivalence(
  ...
  validateFib(
      state->getFibsInfoMap()->getFibContainerIf(RouterID(0))->getFibV6());
  validateFib(
      state->getFibsInfoMap()->getFibContainerIf(RouterID(0))->getFibV4());
}
} // namespace facebook::fboss
