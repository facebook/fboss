...
std::map<int32_t, std::pair<std::string, std::size_t>> _AclTableMap {
  SAI_ATTR_MAP(AclTable, Stage), SAI_ATTR_MAP(AclTable, Stage),
      SAI_ATTR_MAP(AclTable, BindPointTypeList),
      SAI_ATTR_MAP(AclTable, ActionTypeList), SAI_ATTR_MAP(AclTable, EntryList),
      ...
      SAI_ATTR_MAP(AclTable, FieldOutPort), SAI_ATTR_MAP(AclTable, FieldIpFrag),
      ...
      SAI_ATTR_MAP(AclTable, FieldDscp), SAI_ATTR_MAP(AclTable, FieldDstMac),
      SAI_ATTR_MAP(AclTable, FieldIpType), SAI_ATTR_MAP(AclTable, FieldTtl),
