...
class BcmUdfManager {
 public:
  ...
  ~BcmUdfManager();
  BcmUdfManager(const BcmUdfManager&) = delete;
  BcmUdfManager& operator=(const BcmUdfManager&) = delete;
  BcmUdfManager(BcmUdfManager&&) = delete;
  BcmUdfManager& operator=(BcmUdfManager&&) = delete;
  void addUdfConfig(
  ...
  int getBcmUdfGroupProto(const std::string& udfGroupName) const;
  cfg::UdfGroupType getUdfGroupType(const std::string& udfGroupName) const;
  void getUdfAclGroupIds(std::set<bcm_udf_id_t>& bcmUdfGroupIds) const;
