...
bool G202xAsic::isSupportedNonFabric(Feature feature) const {
  switch (feature) {
    /*
...
bool G202xAsic::isSupportedFabric(Feature feature) const {
  switch (feature) {
    case HwAsic::Feature::REMOVE_PORTS_FOR_COLDBOOT:
    case HwAsic::Feature::FABRIC_PORTS:
      return true;
...
int G202xAsic::getDefaultNumPortQueues(
...
std::set<cfg::StreamType> G202xAsic::getQueueStreamTypes(
    cfg::PortType portType) const {
  switch (portType) {
...
G202xAsic::desiredLoopbackModes() const {
...
cfg::Range64 G202xAsic::getReservedEncapIndexRange() const {
