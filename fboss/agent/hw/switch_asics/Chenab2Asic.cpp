...
bool Chenab2Asic::isSupportedNonFabric(Feature feature) const {
  switch (feature) {
    /*
...
bool Chenab2Asic::isSupportedFabric(Feature feature) const {
  switch (feature) {
    case HwAsic::Feature::REMOVE_PORTS_FOR_COLDBOOT:
    case HwAsic::Feature::FABRIC_PORTS:
      return true;
...
int Chenab2Asic::getDefaultNumPortQueues(
...
std::set<cfg::StreamType> Chenab2Asic::getQueueStreamTypes(
    cfg::PortType portType) const {
  switch (portType) {
...
cfg::Range64 Chenab2Asic::getReservedEncapIndexRange() const {
...
HwAsic::AsicVendor Chenab2Asic::getAsicVendor() const {
  return HwAsic::AsicVendor::ASIC_VENDOR_CHENAB;
}
std::string Chenab2Asic::getVendor() const {
  return "chenab_vendor";
}
bool Chenab2Asic::isSupported(Feature feature) const {
...
int Chenab2Asic::getBufferDynThreshFromScalingFactor(
...
bool Chenab2Asic::scalingFactorBasedDynamicThresholdSupported() const {
  return true;
}
phy::DataPlanePhyChipType Chenab2Asic::getDataPlanePhyChipType() const {
  return phy::DataPlanePhyChipType::IPHY;
}
cfg::PortSpeed Chenab2Asic::getMaxPortSpeed() const {
  return cfg::PortSpeed::EIGHTHUNDREDG;
}
uint32_t Chenab2Asic::getMaxLabelStackDepth() const {
  return 3;
}
...
uint64_t Chenab2Asic::getSramSizeBytes() const {
  // No HBM!
  return getMMUSizeBytes();
}

uint32_t Chenab2Asic::getMaxMirrors() const {
  // TODO - verify this
  return 4;
}
std::optional<uint64_t> Chenab2Asic::getDefaultReservedBytes(
    cfg::StreamType /*streamType*/,
    cfg::PortType portType) const {
  if (portType == cfg::PortType::CPU_PORT) {
    return std::nullopt;
...
std::optional<cfg::MMUScalingFactor> Chenab2Asic::getDefaultScalingFactor(
    cfg::StreamType /*streamType*/,
    bool cpu) const {
  if (cpu) {
    return std::nullopt;
...
uint16_t Chenab2Asic::getMirrorTruncateSize() const {
  return 220;
}
uint32_t Chenab2Asic::getMaxWideEcmpSize() const {
  return 128;
}
uint32_t Chenab2Asic::getMaxLagMemberSize() const {
  return 512;
}
int Chenab2Asic::getSflowPortIDOffset() const {
  return 500;
}
uint32_t Chenab2Asic::getSflowShimHeaderSize() const {
  return 9;
}
std::optional<uint32_t> Chenab2Asic::getPortSerdesPreemphasis() const {
  return -15; // must be same as pre1
}
uint32_t Chenab2Asic::getPacketBufferUnitSize() const {
  return 256;
}
uint32_t Chenab2Asic::getPacketBufferDescriptorSize() const {
  return 40;
}
uint32_t Chenab2Asic::getMaxVariableWidthEcmpSize() const {
  return 512;
}
uint32_t Chenab2Asic::getMaxEcmpSize() const {
  return 512;
}
std::optional<uint32_t> Chenab2Asic::getMaxEcmpGroups() const {
  return 4096;
}
std::optional<uint32_t> Chenab2Asic::getMaxEcmpMembers() const {
  return 32000;
}
uint32_t Chenab2Asic::getNumCores() const {
  return 1;
}
uint32_t Chenab2Asic::getStaticQueueLimitBytes() const {
  return 512 * 1024 * getPacketBufferUnitSize();
}
uint32_t Chenab2Asic::getNumMemoryBuffers() const {
  return 1;
}
uint16_t Chenab2Asic::getGreProtocol() const {
  return 0x8949;
}
int Chenab2Asic::getMidPriCpuQueueId() const {
  return kDefaultMidPriCpuQueueId;
}
int Chenab2Asic::getHiPriCpuQueueId() const {
  return kDefaultHiPriCpuQueueId;
}

const std::map<cfg::PortType, cfg::PortLoopbackMode>&
Chenab2Asic::desiredLoopbackModes() const {
...
uint32_t Chenab2Asic::getThresholdGranularity() const {
  return getPacketBufferUnitSize() * 64;
}

std::vector<prbs::PrbsPolynomial> Chenab2Asic::getSupportedPrbsPolynomials()
    const {
...
std::optional<uint32_t> Chenab2Asic::getArsBaseIndex() const {
  return std::nullopt;
}
