...
bool Q4DAsic::isSupported(Feature feature) const {
  switch (feature) {
    ...
    // On Q4D ASIC we don't create any vlans but rather
    ...
    /*
     * Q4D does not support NEXTHOP_TTL_DECREMENT_DISABLE. Similar effect is
