...
TEST(SflowStructsTest, Serialize) {
  ...
  constexpr auto data = folly::make_array<uint8_t>(
      ...
      0x00, 0x00, 0x00, 0x02, // ipv6 type = 2
      0x24, 0x01, 0xdb, 0x00, 0x01, 0x16, 0x30, 0x16, // ......
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1b, // ... ipv6 addr
      0x00, 0x00, 0x00, 0x00, // sub agent
      0x00, 0x00, 0x00, 0x00, // seq no.
      0x00, 0x00, 0x00, 0x00, // uptime
      0x00, 0x00, 0x00, 0x01, // sample cnt
      0x00, 0x00, 0x00, 0x01, // sample type
      0x00, 0x00, 0x00, 0x44, // data length
      0x00, 0x00, 0x00, 0x00, // seq no.
      0x00, 0x00, 0x00, 0x00, // source ID
      0x00, 0x00, 0x00, 0x7b, // sampling rate
      0x00, 0x00, 0x00, 0x00, // sample pool
      0x00, 0x00, 0x00, 0x00, // drops
      0x00, 0x00, 0x00, 0x38, // input port
      0x00, 0x00, 0x00, 0x06, // output port
      0x00, 0x00, 0x00, 0x01, // record cnt
      0x00, 0x00, 0x00, 0x01, // flow format
      0x00, 0x00, 0x00, 0x1c, // header size
      0x00, 0x00, 0x00, 0x01, // protocol
      0x00, 0x00, 0x00, 0x00, // frame length
      0x00, 0x00, 0x00, 0x00, // stripped
      0x00, 0x00, 0x00, 0x0b, // data size
