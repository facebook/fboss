...
//
// `regDumpDevices`: Optional list of devices to dump register data from
// Uses the reg_dump sysfs files located in the /run/devmap entry
//
...
struct ShowtechConfig {
  ...
  8: optional list<string> regDumpDevices;
}
