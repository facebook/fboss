...
EepromData eepromOnieReal = {
    ...
    0x22, 0x0c, 0x39, 0x35, 0x30, 0x2d, 0x30, 0x30, 0x30, 0x30, 0x31, 0x2d, 0x30, 0x31,
    // Serial Number TLV (0x23, length=14, "NH-FSJ25160005")
    0x23, 0x0e, 0x4e, 0x48, 0x2d, 0x46, 0x53, 0x4a, 0x32, 0x35, 0x31, 0x36, 0x30, 0x30, 0x30, 0x35,
...
TEST(FbossEepromOnieTest, OnieFormat) {
  std::vector<std::pair<std::string, std::string>> expectedContentsDummy = {
      ...
      {"Service Tag", ""},
      {"Vendor Extension", ""},
      {"CRC-32", "0x12345678 (CRC Mismatch. Expected 0xBA593F77)"},
  };
  ...
  std::vector<std::pair<EepromData, std::vector<std::pair<std::string, std::string>>>> testCases = {
