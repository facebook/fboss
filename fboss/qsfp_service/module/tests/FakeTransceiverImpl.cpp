...
std::array<uint8_t, 128> kSffPageLower = {
...
std::array<uint8_t, 128> kSffBadPageLower = {
...
std::array<uint8_t, 128> kSffPage0 = {
    ...
    0x07, 0xd0, 0x46, 0x97, 0x00, 0x01, 0x04, 0xd0, 0x4d, 0x52, 0x45, 0x30,
...
std::array<uint8_t, 128> kSffPage3 = {
...
std::map<int, std::array<uint8_t, 128>> kSffUpperPages = {
    {0, kSffPage0},
    {3, kSffPage3}};
...
SffTransceiver::SffTransceiver(int module)
    : FakeTransceiverImpl(module, kSffPageLower, kSffUpperPages) {}

BadSffTransceiver::BadSffTransceiver(int module)
    : FakeTransceiverImpl(module, kSffBadPageLower, kSffUpperPages) {}
