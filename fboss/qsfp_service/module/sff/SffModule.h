...
class SffModule : public QsfpModule {
 ...
 protected:
   ...
   */
  RateSelectState getRateSelectValue() override;
  /*
 ...
 private:
  ...
  int getQsfpDACGauge() const override;
  /*
   ...
   */
  const std::optional<LengthAndGauge> getDACCableOverride() const override;
