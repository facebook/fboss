...
enum class CmisField {
  ...
  // Page 22h
  PAGE_UPPER22H,
  VDM_CONF_PAM4_LEVEL0_SD_LINE,
  VDM_CONF_PAM4_LEVEL1_SD_LINE,
  VDM_CONF_PAM4_LEVEL2_SD_LINE,
  VDM_CONF_PAM4_LEVEL3_SD_LINE,
  VDM_CONF_PAM4_MPI_LINE,
  // Page 24h
  PAGE_UPPER24H,
  VDM_VAL_SNR_MEDIA_IN,
  VDM_VAL_PAM4_LTP_MEDIA_IN,
  ...
  // Page 26h
  PAGE_UPPER26H,
  VDM_VAL_PAM4_LEVEL0_SD_LINE,
  VDM_VAL_PAM4_LEVEL1_SD_LINE,
  VDM_VAL_PAM4_LEVEL2_SD_LINE,
  VDM_VAL_PAM4_LEVEL3_SD_LINE,
