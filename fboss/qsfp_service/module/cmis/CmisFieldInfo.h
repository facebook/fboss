...
enum class CmisField {
  ...
  VDM_CONF_ERR_FRAME_MEDIA_IN_MIN,
  VDM_CONF_ERR_FRAME_MEDIA_IN_MAX,
  VDM_CONF_ERR_FRAME_MEDIA_IN_AVG,
  VDM_CONF_ERR_FRAME_MEDIA_IN_CUR,
  // Page 21h
  PAGE_UPPER21H,
  ...
  VDM_CONF_ERR_FRAME_HOST_IN_MIN,
  VDM_CONF_ERR_FRAME_HOST_IN_MAX,
  VDM_CONF_ERR_FRAME_HOST_IN_AVG,
  VDM_CONF_ERR_FRAME_HOST_IN_CUR,
  // Page 24h
  PAGE_UPPER24H,
  ...
  VDM_VAL_ERR_FRAME_MEDIA_IN_MIN,
  VDM_VAL_ERR_FRAME_MEDIA_IN_MAX,
  VDM_VAL_ERR_FRAME_MEDIA_IN_AVG,
  VDM_VAL_ERR_FRAME_MEDIA_IN_CUR,
  // Page 25h
  PAGE_UPPER25H,
  ...
  VDM_VAL_ERR_FRAME_HOST_IN_MIN,
  VDM_VAL_ERR_FRAME_HOST_IN_MAX,
  VDM_VAL_ERR_FRAME_HOST_IN_AVG,
  VDM_VAL_ERR_FRAME_HOST_IN_CUR,
  // Page 2Fh
  PAGE_UPPER2FH,
  VDM_LATCH_REQUEST,
  VDM_LATCH_DONE,
