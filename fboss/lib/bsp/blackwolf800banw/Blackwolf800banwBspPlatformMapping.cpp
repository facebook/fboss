...
static BspPlatformMappingThrift buildBlackwolf800banwPlatformMapping(
...
Blackwolf800banwBspPlatformMapping::Blackwolf800banwBspPlatformMapping()
    : BspPlatformMapping(
          buildBlackwolf800banwPlatformMapping(kJsonBspPlatformMappingStr)) {}

Blackwolf800banwBspPlatformMapping::Blackwolf800banwBspPlatformMapping(
    const std::string& platformMappingStr)
    : BspPlatformMapping(
          buildBlackwolf800banwPlatformMapping(platformMappingStr)) {}
