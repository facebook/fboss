...
static BspPlatformMappingThrift buildIcecube800banwPlatformMapping(
...
Icecube800banwBspPlatformMapping::Icecube800banwBspPlatformMapping()
    : BspPlatformMapping(
          buildIcecube800banwPlatformMapping(kJsonBspPlatformMappingStr)) {}

Icecube800banwBspPlatformMapping::Icecube800banwBspPlatformMapping(
    const std::string& platformMappingStr)
    : BspPlatformMapping(
          buildIcecube800banwPlatformMapping(platformMappingStr)) {}
