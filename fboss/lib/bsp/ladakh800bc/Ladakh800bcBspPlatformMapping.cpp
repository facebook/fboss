...
static BspPlatformMappingThrift buildLadakh800bcPlatformMapping(
...
Ladakh800bcBspPlatformMapping::Ladakh800bcBspPlatformMapping()
    : BspPlatformMapping(
          buildLadakh800bcPlatformMapping(kJsonBspPlatformMappingStr)) {}

Ladakh800bcBspPlatformMapping::Ladakh800bcBspPlatformMapping(
    const std::string& platformMappingStr)
    : BspPlatformMapping(buildLadakh800bcPlatformMapping(platformMappingStr)) {}
