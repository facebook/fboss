...
static BspPlatformMappingThrift buildIcetea800bcPlatformMapping(
...
Icetea800bcBspPlatformMapping::Icetea800bcBspPlatformMapping()
    : BspPlatformMapping(
          buildIcetea800bcPlatformMapping(kJsonBspPlatformMappingStr)) {}

Icetea800bcBspPlatformMapping::Icetea800bcBspPlatformMapping(
    const std::string& platformMappingStr)
    : BspPlatformMapping(buildIcetea800bcPlatformMapping(platformMappingStr)) {}
