...
static BspPlatformMappingThrift buildMinipack3BTAPlatformMapping(
...
Minipack3BTABspPlatformMapping::Minipack3BTABspPlatformMapping()
    : BspPlatformMapping(
          buildMinipack3BTAPlatformMapping(kJsonBspPlatformMappingStr)) {}

Minipack3BTABspPlatformMapping::Minipack3BTABspPlatformMapping(
    const std::string& platformMappingStr)
    : BspPlatformMapping(buildMinipack3BTAPlatformMapping(platformMappingStr)) {
}
