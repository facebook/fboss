...
static BspPlatformMappingThrift buildMinipack3NPlatformMapping(
...
Minipack3NBspPlatformMapping::Minipack3NBspPlatformMapping()
    : BspPlatformMapping(
          buildMinipack3NPlatformMapping(kJsonBspPlatformMappingStr)) {}

Minipack3NBspPlatformMapping::Minipack3NBspPlatformMapping(
    const std::string& platformMappingStr)
    : BspPlatformMapping(buildMinipack3NPlatformMapping(platformMappingStr)) {}
